...
<head>
    ...
    <title>{{ config('app.name', 'Shopper Simple Cart') }} - @yield('title', 'Home')</title>

    <link rel="icon" href="{{ url('assets/img/favicon-32x32.png') }}" type="image/png" sizes="16x16">
...
<body class="bg-gray-100">
    ...
    <!-- Announcement Banner -->
    <div class="py-2 bg-black text-center dark:bg-white">
    ...
    <!-- Header -->
    <header class="flex flex-wrap lg:justify-start lg:flex-nowrap z-50 w-full py-4 bg-white shadow-sm">
        <nav class="relative max-w-7xl w-full flex flex-wrap lg:grid lg:grid-cols-12 basis-full items-center px-4 md:px-6 lg:px-8 mx-auto">
            <div class="lg:col-span-3 flex items-center">
                ...
                <a href="{{ route('home') }}" class="flex mr-4">
                    <img src="{{ asset('assets/img/logo.png') }}" class="mr-3 h-8" alt="Shopper Simple Cart Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Shopper</span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-x-1 lg:gap-x-2 ms-auto py-1 lg:ps-6 lg:order-3 lg:col-span-3">
                ...
                <a href="{{ route('login') }}" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl border border-transparent bg-yellow-400 text-black hover:bg-yellow-500 focus:outline-hidden focus:bg-yellow-500 transition disabled:opacity-50 disabled:pointer-events-none">
                    Sign in
                </a>
            ...
            <div id="hs-pro-hcail" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow lg:block lg:w-auto lg:basis-auto lg:order-2 lg:col-span-6" aria-labelledby="hs-pro-hcail-collapse">
                ...
                <div>
                    <a class="relative inline-block text-black focus:outline-hidden before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-yellow-400 dark:text-white" href="{{ route('home') }}" aria-current="page">Home</a>
                </div>
                <div>
                    <a class="inline-block text-black hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="#">Shop</a>
                </div>
                <div>
                ...
                <div>
                    <a class="inline-block text-black hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-white dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="#">Track Your Order</a>
                </div>
                </div>
            </div>
            <!-- End Collapse -->
    ...
    <footer class="bg-white mt-12 py-6 text-center text-gray-600">
        <p>&copy; {{ date('Y') }} {{ config('app.name', 'Simple Shopper Cart') }}. All rights reserved.</p>
    </footer>
